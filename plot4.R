...
par(mfrow = c(2,2))
with(workingDataset, {
     plot(workingDataset$Time, workingDataset$Global_active_power,typ='l',xlab="",ylab="Global Active Power")
     plot(workingDataset$Time, workingDataset$Voltage,typ='l',xlab="datetime",ylab="Voltage")
     ...
     plot(workingDataset$Time, workingDataset$Global_reactive_power,typ='l',xlab="datetime",ylab="Global_reactive_power")
})
dev.off()
